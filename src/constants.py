...
from cpp_solvers import CPP_ImprovedBacktracker, CPP_BacktrackingSolver_V2, CPP_BacktrackingSolver_V3, CPP_IDsolver, CPP_IDSudokuSolver, CPP_IDColoringSolver
...
CPP_IDHamcycleSolver = CPP_BacktrackingSolver_V2
